    ...
    <>
      <dialog id="modal-example">
        <article>
          ...
          <h4>Terms & Privacy</h4>
          <p>
            At FotoFusion, accessible from www.fotofusion.com, one of our main
            priorities is the privacy of our visitors. This Privacy Policy
            document contains types of information that is collected and
            recorded by FotoFusion and how we use it. If you have additional
            ...
            FotoFusion. This policy is not applicable to any information
          ...
          <h5>Log Files</h5>
          <p>
            FotoFusion follows a standard procedure of using log files. These
          ...
          <p>
            ...
            advertising partners of FotoFusion.
          </p>
          <p>
            Third-party ad servers or ad networks uses technologies like
            cookies, JavaScript, or Web Beacons that are used in their
            respective advertisements and links that appear on FotoFusion, which
          ...
          <p>
            Note that FotoFusion has no access to or control over these cookies
            that are used by third-party advertisers.
          </p>
          <h5>Third Party Privacy Policies</h5>
          <p>
            FotoFusion's Privacy Policy does not apply to other advertisers or
